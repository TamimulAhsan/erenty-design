  ...
  const handleNextStep = () => {
    if (step === 1) {
      ...
      if (hasEmptyVin) {
        ...
        showToast("Please enter a VIN / Frame Number for each vehicle.");
        return;
      }
      ...
      if (paymentMethod === "card") {
        if (!cardName.trim()) {
          showToast("Please enter the cardholder's name.");
          return;
        }
          ...
          <div className={styles.checkoutContainer}>
              ...
              {step === 1 ? (
                <>
                  <div>
                    ...
                    <h1 className={`${styles.sectionTitle} h2`}>Configure your subscription</h1>
                    <p className={styles.sectionSubtitle}>
                      Select your plan, billing frequency and input your vehicles. Longer commitments save more.
                    </p>
                  </div>
                  ...
                  <div className={styles.planSwitcherHero}>
                    <div className={styles.planSwitcherHeroLeft}>
                      <div className={styles.planSwitcherHeroHeader}>
                        <span className={styles.planHeroLabel}>Selected Coverage Plan</span>
                        <h3 className={styles.planHeroName}>{selectedPlan.name} Plan</h3>
                      </div>
                    ...
                    <div className={styles.planSwitcherHeroRight}>
                      <div className={styles.planHeroPriceWrapper}>
                        ...
                        <span className={styles.planHeroPeriod}>/ month / bike</span>
                      </div>
                  ...
                  <div className={styles.alternativesToggleWrapper}>
                    ...
                    >
                      <span>Or switch to another coverage</span>
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 24 24"
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={styles.planSwitcherPriceWrapper}>
                              ...
                              <span className={styles.planSwitcherPeriod}>/ month / bike</span>
                            </div>
                          </div>
                        );
                      })}
                  ...
                  <div className={styles.formSection}>
                    <h4 className={styles.sectionHeading}>Billing Cycle</h4>
                    <div className={styles.cycleGrid}>
                      ...
                      >
                        <div className={styles.cycleHeader}>
                          <span className={styles.cycleName}>Monthly</span>
                        </div>
                        <span className={styles.cyclePrice}>{formatPrice(selectedPlan.price)} Ft / month</span>
                        <span className={styles.cycleSavingsPlaceholder}>Standard rate</span>
                      </div>
                      ...
                      >
                        <div className={styles.cycleHeader}>
                          <span className={styles.cycleName}>Quarterly</span>
                        </div>
                        <span className={styles.cyclePrice}>{formatPrice(selectedPlan.price * 3)} Ft / cycle</span>
                        <span className={styles.cycleSavingsPlaceholder}>Standard rate</span>
                      </div>
                      ...
                      >
                        <div className={styles.cycleHeader}>
                          <span className={styles.cycleName}>6 Months</span>
                        </div>
                        <span className={styles.cyclePrice}>{formatPrice(selectedPlan.price * 6)} Ft / cycle</span>
                        <span className={styles.cycleSavingsPlaceholder}>Standard rate</span>
                      </div>
                      ...
                      >
                        <div className={styles.cycleHeader}>
                          <span className={styles.cycleName}>Yearly</span>
                        </div>
                        <span className={styles.cyclePrice}>{formatPrice(selectedPlan.price * 12)} Ft / year</span>
                        <span className={styles.cycleSavingsPlaceholder}>Standard rate</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.formSection}>
                    <h4 className={styles.sectionHeading}>Number of Vehicles</h4>
                    <div className={styles.counterRow}>
                      ...
                      <div className={styles.counterLabelInfo}>
                        <span className={styles.counterMainPrice}>
                          {formatPrice(selectedPlan.price * vehicles)} Ft <span style={{ fontSize: "13px", fontWeight: "normal" }}>/ month</span>
                        </span>
                        <span className={styles.counterSubPrice}>
                          {formatPrice(selectedPlan.price)} Ft per vehicle / month
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.formSection}>
                    <h4 className={styles.sectionHeading}>VIN / Frame Number</h4>
                    <p className={styles.sectionSubtitle} style={{ marginBottom: "16px", fontSize: "13px" }}>
                      Enter the VIN or frame number for each vehicle. You can find this on the frame or in your vehicle documents.
                    </p>
                    <div className={styles.vinInputsList}>
                      {vins.map((vin, idx) => (
                        <div key={idx} className={styles.vinField}>
                          {vehicles > 1 && (
                            <label className={styles.vinFieldLabel}>Vehicle {idx + 1} VIN</label>
                          )}
                          <input
                            type="text"
                  ...
                  <div className={styles.formSection}>
                    <h4 className={styles.sectionHeading}>What's Included</h4>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className={styles.addOnRight}>
                              ...
                              <span className={styles.addOnPeriod}>/ month</span>
                            </div>
                          </div>
                        );
                      })}
                ...
                <>
                  <div>
                    ...
                    <h1 className={`${styles.sectionTitle} h2`}>How would you like to pay?</h1>
                    <p className={styles.sectionSubtitle}>
                      Pay now to activate your plan. We'll send a Hungarian VAT invoice within minutes.
                    </p>
                  </div>
                  ...
                  <div className={styles.paymentTabs}>
                    ...
                    >
                      ...
                      <span className={styles.payTabLabel}>Card</span>
                    ...
                    >
                      ...
                      <span className={styles.payTabLabel}>Google Pay</span>
                      <span className={styles.payTabDesc}>One tap</span>
                    </div>
                    ...
                    <div
                      ...
                      onClick={() => {
                        if (!isAppleDevice) {
                          showToast("Apple Pay is only available on iOS or macOS devices.");
                          return;
                        }
                    ...
                    >
                      ...
                      <span className={styles.payTabLabel}>Apple Pay</span>
                      <span className={styles.payTabDesc}>iOS / macOS only</span>
                    </div>
                  </div>
                  ...
                  {paymentMethod === "card" ? (
                    <div className={styles.formSection}>
                      <div className={styles.stripeHeader}>
                        <h4 className={styles.stripeTitle}>Card details</h4>
                        <span className={styles.stripeLabel}>Secured by Stripe</span>
                      </div>
                      ...
                      <div className={styles.vinInputsList} style={{ marginTop: "16px" }}>
                        ...
                        <label className={styles.saveCardRow}>
                          ...
                          />
                          <span className={styles.saveCardLabel}>Save this card for future payments</span>
                        </label>
                      </div>
                    </div>
                  ) : (
                    <div className={styles.formSection} style={{ textAlign: "center", padding: "40px" }}>
                      ...
                      <p className={styles.sectionSubtitle}>
                        Your browser or device supports fast checkout with {paymentMethod === "gpay" ? "Google" : "Apple"} Pay.
                      </p>
                    </div>
                  )}
                  ...
                  <div className={styles.secureFooter}>
                    ...
                    <div className={styles.secItem}>
                      ...
                      <span>No card stored on our servers</span>
                    </div>
                  </div>
            ...
            <div className={styles.rightColumn}>
              <div className={styles.summaryCard}>
                <h4 className={styles.summaryTitle}>Your Order</h4>
                ...
                <div className={styles.summaryProduct}>
                  ...
                  <div className={styles.summaryProdInfo}>
                    ...
                    <span className={styles.summaryProdCycle}>
                      {vehicles} vehicle{vehicles > 1 ? "s" : ""} · {getCycleDisplayName()}
                    </span>
                  </div>
                </div>
                    ...
                    (key) =>
                      addOns[key] && (
                        <div key={key} className={styles.summaryLine}>
                          <span className={styles.summaryLineName}>
                            + {ADD_ONS[key].name} × {vehicles} (monthly)
                          </span>
                          <span className={styles.summaryLineValue}>
                ...
                <div className={styles.summaryTotalRow}>
                  <span className={styles.summaryTotalLabel}>Due today</span>
                ...
                {activeCoupon && (
                  <div className={`${styles.couponFeedback} ${styles.couponSuccess}`}>
                    ✓ Coupon code <strong>{activeCoupon}</strong> applied (10% discount)
                  </div>
                )}
                {couponError && (
                ...
                {step === 1 ? (
                  ...
                  >
                    Pay {formatPrice(totalPriceDue)} Ft & confirm
                  </button>
                )}
              </div>
            </div>
          ...
          <div className={styles.confirmWrapper}>
            <div className={styles.confirmBanner}>
              <div className={styles.confirmBannerLeft}>
                ...
                <h1 className={styles.confirmTitle}>You're all covered.</h1>
            ...
            <div>
              <h4 className={styles.whatNextTitle}>What happens next</h4>
              <div className={styles.nextStepsGrid}>
                <div className={styles.stepCard}>
                  <div className={styles.stepCardHeader}>
                    ...
                    <span className={styles.stepCardTime}>Now</span>
                  </div>
                  <h5 className={styles.stepCardTitle}>Subscription Activated</h5>
                  <p className={styles.stepCardDesc}>
                    Your plan is live. Invoice and plan details emailed to your inbox.
                  </p>
                </div>
                ...
                <div className={styles.stepCard}>
                  <div className={styles.stepCardHeader}>
                    ...
                    <span className={styles.stepCardTime}>Next</span>
                    <span className={styles.stepActiveDot} />
                  </div>
                  <h5 className={styles.stepCardTitle}>Configure Vehicle</h5>
                  <p className={styles.stepCardDesc}>
                    Set up VIN/Frame Number of your vehicle/s in dashboard.
                  </p>
                </div>
                ...
                <div className={styles.stepCard}>
                  <div className={styles.stepCardHeader}>
                    ...
                    <span className={styles.stepCardTime}>Then</span>
                  </div>
                  <h5 className={styles.stepCardTitle}>Collect Items</h5>
                  <p className={styles.stepCardDesc}>
                    Collect your items from our pickup point.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.confirmBottomSplit}>
              <div className={styles.receiptCard}>
                <h4 className={styles.receiptHeading}>Receipt</h4>
                    ...
                    (key) =>
                      addOns[key] && (
                        <div key={key} className={styles.receiptLine}>
                          <span>+ {ADD_ONS[key].name} × {vehicles} (monthly)</span>
              ...
              <div className={styles.addMoreCard}>
                <div className={styles.addMoreHeader}>
                  ...
                  <h4 className={styles.addMoreTitle}>Add more vehicles to your fleet</h4>
                  <p className={styles.addMoreDesc}>
                    Manage multiple vehicles under one plan. Visit your dashboard to add more vehicles to your Courier+ coverage.
                  </p>
                </div>
                <div>
        ...
        <div className={styles.invoiceModalBackdrop}>
          <div className={styles.invoiceModalContainer}>
            <div className={styles.invoiceModalHeaderBar}>
              <span className={styles.invoiceModalTitle}>Subscription Invoice</span>
            ...
            <div className={styles.invoiceSheet}>
              ...
              <div className={styles.billingSection}>
                <div className={styles.billTo}>
                  <h3>Bill To</h3>
                  <p className={styles.customerName}>{cardName || "Customer"}</p>
                  <p className={styles.fleetInfo}>
                    Fleet subscription size: {vehicles} vehicle{vehicles > 1 ? "s" : ""}
                  </p>
                </div>
                ...
                <div className={styles.summaryBox}>
                  ...
                  {discountPercent > 0 && (
                    <div className={`${styles.summaryRow} ${styles.discountRow}`}>
                      <span>Discount ({discountPercent}% {activeCoupon && `- "${activeCoupon}"`}):</span>
              ...
              <div className={styles.sheetFooter}>
                <p className={styles.thankYou}>Thank you for choosing E-RENTY for maintaining your fleet.</p>
